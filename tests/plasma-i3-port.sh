...
assert_contains modules/nixos/desktop/kde/default.nix 'DesktopNames=plasma-i3;KDE'
...
assert_contains modules/home/configs/eww-plasma-i3/scripts/workspaces.sh 'monitor_index'
...
assert_not_contains modules/home/configs/eww-plasma-i3/scripts/workspaces.sh 'local start_ws=\$\(\(monitor_id \* 4 \+ 1\)\)'
assert_not_contains modules/home/configs/eww-plasma-i3/scripts/workspaces.sh 'if \[ "\$monitor_id" = "1" \]; then'
assert_contains modules/home/configs/eww-plasma-i3/scripts/workspaces.sh 'start_ws=5'
